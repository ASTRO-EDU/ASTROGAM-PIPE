...
if os.path.exists(outdir+'ARCH.XSTRIP.TOP.eASTROGAMV1.0.TRACKER.FITS'):
	os.remove(outdir+'ARCH.XSTRIP.TOP.eASTROGAMV1.0.TRACKER.FITS')
	tbhdu.writeto(outdir+'ARCH.XSTRIP.TOP.eASTROGAMV1.0.TRACKER.FITS')
else:
	tbhdu.writeto(outdir+'ARCH.XSTRIP.TOP.eASTROGAMV1.0.TRACKER.FITS')

fits.setval(outdir+'ARCH.XSTRIP.TOP.eASTROGAMV1.0.TRACKER.FITS', 'COMMENT', value='Creator = Giovanni Giannella & Simone Guidotti', ext=1)
fits.setval(outdir+'ARCH.XSTRIP.TOP.eASTROGAMV1.0.TRACKER.FITS', 'COMMENT', value='eASTROGAM release = V1.0', ext=1)
...
if os.path.exists(outdir+'ARCH.YSTRIP.TOP.eASTROGAMV1.0.TRACKER.FITS'):
	os.remove(outdir+'ARCH.YSTRIP.TOP.eASTROGAMV1.0.TRACKER.FITS')
	tbhdu.writeto(outdir+'ARCH.YSTRIP.TOP.eASTROGAMV1.0.TRACKER.FITS')
else:
	tbhdu.writeto(outdir+'ARCH.YSTRIP.TOP.eASTROGAMV1.0.TRACKER.FITS')

fits.setval(outdir+'ARCH.YSTRIP.TOP.eASTROGAMV1.0.TRACKER.FITS', 'COMMENT', value='Creator = Giovanni Giannella & Simone Guidotti', ext=1)
fits.setval(outdir+'ARCH.YSTRIP.TOP.eASTROGAMV1.0.TRACKER.FITS', 'COMMENT', value='eASTROGAM release = V1.0', ext=1)

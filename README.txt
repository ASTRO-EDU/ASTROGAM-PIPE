...
RELEASE: Version 1.1   10/03/2017

ALGORITHM CREATOR: V. Fioretti

AUTHORS:  G. Giannella  &  S. Guidotti

REFERENCE: eASTROGAM_ANALYSISv32_file_remote.pro
...
- The software needs the two files generated by the eASTROGAM_Geometry.py, which must run first.

- The input parameters must be set up using the file eASTROGAM_ANALYSISv1_input.ll

- The eASTROGAM_ANALYSISv1_file_remote.py must be in the same directory of DHSim.py
